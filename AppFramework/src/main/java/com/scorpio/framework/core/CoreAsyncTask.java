...
public abstract class CoreAsyncTask<Params, Progress, Result> {
	 ...
	 *             {@link CoreAsyncTask.Status#RUNNING} or
	 *             {@link CoreAsyncTask.Status#FINISHED}.
	 *
	...
	public final CoreAsyncTask<Params, Progress, Result> executeOnExecutor(
	...
	private static class AsyncTaskResult<Data> {
		...
		AsyncTaskResult(@SuppressWarnings("rawtypes") CoreAsyncTask task,
				Data... data) {
			mTask = task;
			mData = data;
		}
