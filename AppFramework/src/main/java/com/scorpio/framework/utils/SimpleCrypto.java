...
public class SimpleCrypto {
	...
	public static String SEED = "fanxer88";

	/**
	 * 
	 * @param cleartext
	 * @return return null if encrypt has error
	 */
	public static String encrypt(String cleartext) {
		try {
			return encrypt(SEED, cleartext);
		} catch (Exception e) {
			ScoLog.E(TAG, "encrypt error...");
			e.printStackTrace();
			return null;
		}
	}
	 ...
	 * 
	 * @param encrypted
	 * @return return null if decrypt has error
	 */
