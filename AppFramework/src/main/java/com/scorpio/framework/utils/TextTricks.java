...
public class TextTricks {
	public static String joinWithPrefix(String prefix, String[] list,
                                        String separator) {
	...
	public static String listToParagraph(List<String> list, String comma,
                                         String and) {
